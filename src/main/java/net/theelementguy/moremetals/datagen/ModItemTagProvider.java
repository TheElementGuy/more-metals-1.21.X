...
public class ModItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ItemTags.TRIM_MATERIALS).add(ModItems.CUBIC_ZIRCONIA.get()).add(ModItems.TIN_SCRAPS.get()).add(ModItems.STARSHARD.get()).add(ModItems.RUBIDIUM.get()).add(ModItems.BRONZE_INGOT.get());
