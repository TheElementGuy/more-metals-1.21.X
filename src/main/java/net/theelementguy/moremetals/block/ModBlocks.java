...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> CUBIC_ZIRCONIUM_BLOCK = registerFireproofBlock("cubic_zirconia_block", () -> new Block(BlockBehaviour.Properties.of().destroyTime(5f).mapColor(DyeColor.WHITE).explosionResistance(6f).sound(SoundType.METAL).requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> RAW_CUBIC_ZIRCONIUM_BLOCK = registerFireproofBlock("raw_cubic_zirconia_block", () -> new Block(BlockBehaviour.Properties.of().destroyTime(5f).mapColor(DyeColor.MAGENTA).explosionResistance(6f).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
