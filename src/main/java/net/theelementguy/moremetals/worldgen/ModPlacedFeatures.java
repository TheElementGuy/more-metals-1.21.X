...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, TIN_SMALL_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.TIN_SMALL_ORE_KEY), ModOrePlacemet.commonOrePlacement(8, HeightRangePlacement.triangle(VerticalAnchor.absolute(-56), VerticalAnchor.absolute(8))));

        register(context, TIN_LARGE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.TIN_LARGE_ORE_KEY), ModOrePlacemet.commonOrePlacement(5, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(48))));

        register(context, RUBIDIUM_LARGE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.RUBIDIUM_LARGE_ORE_KEY), ModOrePlacemet.rareOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.absolute(30), VerticalAnchor.absolute(46))));

        register(context, RUBIDIUM_SMALL_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.RUBIDIUM_SMALL_ORE_KEY), ModOrePlacemet.commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(56))));

        register(context, STARSHARD_LARGEE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.STARSHARD_LARGE_ORE_KEY), ModOrePlacemet.commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));

        register(context, STARSHARD_SMALL_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.STARSHARD_SMALL_ORE_KEY), ModOrePlacemet.commonOrePlacement(20, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
    }
