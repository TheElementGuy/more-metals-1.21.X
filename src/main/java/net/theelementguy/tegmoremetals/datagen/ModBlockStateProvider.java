...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void blockItem(DeferredBlock<?> deferredBlock) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("tegmoremetals:block/" + deferredBlock.getId().getPath()));
    }

    private void glazedTerracottaBlockWithItem(DeferredBlock<?> deferredBlock) {
        //horizontalBlock((Block) deferredBlock.get(), ResourceLocation.fromNamespaceAndPath("tegmoremetals", "block/" + deferredBlock.getId().getPath()), ResourceLocation.fromNamespaceAndPath("tegmoremetals", "block/" + deferredBlock.getId().getPath()), ResourceLocation.fromNamespaceAndPath("tegmoremetals", "block/" + deferredBlock.getId().getPath()));
