...
import net.theelementguy.tegmoremetals.worldgen.ModBiomeModifiers;
...
public class ModDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public static RegistrySetBuilder BUILDER = new RegistrySetBuilder().add(Registries.CONFIGURED_FEATURE, ModConfiguredFeatures::bootstrap).add(Registries.PLACED_FEATURE, ModPlacedFeatures::bootstrap).add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ModBiomeModifiers::bootstrap).add(Registries.TRIM_MATERIAL, ModTrimMaterials::bootstrap);
